public class NightlyConfiguration {

    def static NIGHTLY-ROCMFORK-DEVELOP-UPSTREAM = [
        "ROCM_PATH":true,
    ...
    def static nightly-rocmfork-r28 = []

    def static nightly-rocmfork-r29 = []

    def static nightly-upstream-r28 = []

    def static NIGHTLY-UPSTREAM-R29 = [
        "ROCM_PATH":false,
    ...
    def static NIGHTLY-UPSTREAM-MASTER = [
        "ROCM_PATH":true,
